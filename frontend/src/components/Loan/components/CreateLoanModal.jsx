...
export const CreateLoanModal = ({
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-[220] bg-slate-950/60 backdrop-blur-md">
        <div className="flex h-full w-full items-center justify-center px-3 py-4 md:px-6 md:py-6">
              ...
              <div className="grid gap-6 p-6 xl:grid-cols-2">
                ...
                <div className="space-y-4 rounded-[28px] border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 p-5">
                  ...
                  <button
                    ...
                    className="w-full rounded-2xl bg-blue-600 px-5 py-4 text-sm font-black text-white shadow-lg shadow-blue-500/30 transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    Agregar
                  </button>
                </div>
