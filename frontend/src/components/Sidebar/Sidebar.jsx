    ...
    <div className="flex flex-col w-full relative">
      <div
        ...
        className={`relative flex items-center h-12 mx-3 cursor-pointer transition-colors duration-200 group z-10
          ${active ? "text-blue-600 dark:text-white" : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white"}`}
      >
        {active && (
          <motion.div
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 w-full">
        ...
        <div className="px-3">
          ...
          >
            ...
            <div
              className={`flex items-center justify-center w-12 h-12 ${isExpanded ? "ml-auto mr-1" : "mx-auto"}`}
            >
              {isExpanded ? (
      ...
      <div className="flex flex-col gap-2 w-full mb-2">
        <div className="h-[1px] bg-slate-100 dark:bg-white/5 w-full mb-2" />
        <SidebarItem
          icon={Settings}
          label="Configuración"
          isExpanded={isExpanded}
