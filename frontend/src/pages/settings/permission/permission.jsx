...
import { ChevronDown, Sun, Moon, Shield, Wrench } from "lucide-react";
  ...
  const maintenanceSections = [
    {
      id: "persona",
      title: "Persona",
      description: "Gestión de datos de personas.",
    },
    {
      id: "usuario",
      title: "Usuario",
    ...
    },
    {
      id: "grupo",
      title: "Grupo",
      description: "Agrupación y clasificación de usuarios.",
    },
    {
      id: "perfil",
      title: "Perfil",
    ...
    },
    {
      id: "subsistema",
      title: "Sub-sistema",
      description: "Catálogo de sub-sistemas disponibles.",
    },
    {
      id: "clase",
      title: "Clase",
      description: "Clases disponibles dentro del mantenimiento.",
    },
    {
      id: "metodo",
      title: "Método",
      description: "Métodos asociados a cada clase.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-full flex flex-col bg-white/80 dark:bg-[#0f1115]/80 backdrop-blur-md p-6 md:p-8 rounded-[28px] border border-slate-100 dark:border-white/5 shadow-2xl h-full min-h-0 overflow-y-auto custom-scrollbar">
            ...
            >
              ...
              <div
                id="mantenimiento"
                className="pt-4 border-t border-slate-200 dark:border-white/5 scroll-mt-24"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {maintenanceSections.map((section) => (
                    <section
                      key={section.id}
                      id={section.id}
                      className="scroll-mt-24 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50/70 dark:bg-white/5 p-4"
                    >
